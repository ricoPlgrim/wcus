                ...
                <ul class="step-area v2">
                    ...
                    <li>
                        <div class="payment-type">
                            ...
                            <div class="box-type">
                                ...
                                <dl>
                                    ...
                                    <dd><span class="focus"><b>- $8.20</b></span></dd>
                                </dl>
                                <!-- 회원(e) -->
                                <!-- 반품 수수료 있을경우(s) -->
                                <dl>
                                    <dt>Return Shipping Fee</dt>
                                    <dd><span class="focus"><b>- $8.00</b></span></dd>
                                </dl>
                                <p class="guide">Payment method : From the refund amount</p>
                                <!-- 반품 수수료 있을경우(e) -->
                                <dl>
                                    <dt><strong>Grand Total</strong></dt>
                                    <dd><strong><b>$170.21</b></strong></dd>
                                </dl>
                            </div>
                            <div class="box-type fee">
                                <dl>
                                    <dt>Correction amount</dt>
                                    <dd><span><b>$1.00</b></span></dd>
                                </dl>
                                <dl>
                                    <dt>Tax</dt>
                        ...
                        <div class="notice-box">
                            <strong>Return Policy Notice <em class="focus">*</em></strong>
                            <p>By completing and submitting your return request, you agree to W Concept’s return policy and
                                terms of use.</p>
                            <div class="chk-box">
                                <input type="checkbox" id="agree" />
                                <label class="checkbox" for="agree"></label>
                                <label for="agree">I agree to the return policy and terms of use.</label>
                            </div>
                        </div>
                        <div class="btn-wrap">
                            <!-- 2023-09-26 버튼명수정 -->
                            <!-- 비활성화 -->
                            <!-- <a href="#" class="btn-type btn-full disabled">REQUEST RETURN</a> -->
                            <a href="#" class="btn-type btn-full v3">REQUEST RETURN</a>
                        </div>
                    </li>
                </ul>
            </section>
  ...
  products: [
    {
      ...
      quantity: 1,  // 주문 수량
      price: '$245.00',  // 제품 가격
      hasReturnOption:  true,  // 반품 옵션 여부 (true: 반품 가능, false: 반품 불가)
